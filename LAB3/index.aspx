...
<form id="form1" runat="server">
    ...
    <asp:GridView CssClass="full-width" runat="server" EnableViewState="False" ID="dg_display" BorderColor="peru" BorderWidth="1" CellPadding="3" Font-Names="Roboto" Font-Size="1.2em" AutoGenerateColumns="False" EnablePersistedSelection="True" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" OnRowCommand="dg_display_OnRowCommand">
